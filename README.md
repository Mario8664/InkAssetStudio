...
当前实现覆盖计划中的 Studio 范围：多 Ink Group、Plane/Cuboid/Sphere、完整 Outline/Fill 工具、压感开关、简化地形、Map Reference、Ink 专属硬阴影、完整可调的 Painting 兼容预览灯光、直接可见的 Undo/Redo、IndexedDB 自动保存、工作文件导入导出和离线应用外壳。Painting 侧导入器、HTTPS 部署和 iPad 配对仍属于后续单独工作。
